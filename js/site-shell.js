(function () {
  ...
  function isActive(page) {
    if (page === "products") {
      return ["products", "electronics", "mechanical", "mechatronics", "renewable", "process-control", "product-details", "process-control", "process-control"].includes(active);
    }
    if (page === "process-control") {
      return active === "process-control" || active === "process-control";
    }
    return active === page;
  }
    ...
    footer.innerHTML = `
      <div class="footer-content">
        <div class="footer-section">
          <h4><span style="font-size:1.1em; font-weight:700; color:#0ea5e9;">INTELITEK</span> edu solution private limited</h4></h4>
        ...
        <div class="footer-section">
          ...
          <p><a href="tel:+91+91 9187562018">+91 9187562018</a></p>
        </div>
      </div>
